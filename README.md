...
프로젝트 루트 디렉토리에서 `docker-compose`를 사용하여 필요한 인프라(MySQL, Redis, Kafka, Kafka-UI)를 실행합니다.
...
- **MySQL**: `localhost:3306` (root / password, DB: coffee_order_db)
- **Redis**: `localhost:6379`
- **Kafka**: `localhost:9092`
- **Kafka-UI**: `http://localhost:8090` (브라우저에서 Kafka 토픽 및 메시지 확인 가능)
